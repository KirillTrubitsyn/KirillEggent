...
|------|--------|---------------------------|-------------------|
| **Chat (основная)** | `anthropic/claude-sonnet-4-6` | $3 / $15 | 80% задач: быстрые ответы, код, повседневное |
| **Utility (сложные задачи)** | `anthropic/claude-opus-4-6` | $5 / $25 | Сложный анализ, агентные цепочки, длинный контекст |
...
На уровне проекта можно задать другую модель — медиа-проект на Gemini, сложные задачи автоматически через Opus.
